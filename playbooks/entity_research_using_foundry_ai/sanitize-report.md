...
## Changes Applied
- Renamed workflow parameter 'workflows_entity_reasearch_using_foundry_ai_name' to 'logicAppName'
- Removed template parameter connections_azuresentinel_2_externalid
...
- Removed connectionProperties from 'azuresentinel-2'
- Normalized connector 'azuresentinel-2' to dynamic connection variable 'MicrosoftSentinelConnectionName'
