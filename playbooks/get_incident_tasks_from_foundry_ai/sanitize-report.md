...
## Changes Applied
- Renamed workflow parameter 'workflows_get_incident_tasks_from_foundry_ai_name' to 'logicAppName'
- Removed template parameter connections_azuresentinel_1_externalid
