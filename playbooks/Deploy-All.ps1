...
if (-not $playbooks -or $playbooks.Count -eq 0) {
    throw "No playbook folders with azuredeploy.json were found under: $playbooksRoot. Run this script from the repository playbooks folder, or use .\\playbooks\\Deploy-All.ps1 from the repo root."
}
